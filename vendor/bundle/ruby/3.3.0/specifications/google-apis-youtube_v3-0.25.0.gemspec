# -*- encoding: utf-8 -*-
# stub: google-apis-youtube_v3 0.25.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<google-apis-core>.freeze, [">= 0.9.1".freeze, "< 2.a".freeze])
end
